...
Feature: The Admin page's tabs work in a real browser
  As the site owner
  I want the Test Results and TBD tabs to sit side by side and switch properly
  ...
  Scenario: Clicking a tab shows its panel and the address remembers it
    ...
    Then the "TBD" tab should be selected, its panel visible and the other panel hidden
    And the address should end with "#tbd"
  ...
  Scenario: Arrow keys, Home and End move between tabs and wrap around
    ...
    Then the "TBD" tab should be selected and focused
  ...
  Scenario: A link to #tbd opens the TBD tab
    When I open "/admin/#tbd"
    Then the "TBD" tab should be selected, its panel visible and the other panel hidden
  ...
  Scenario: The tabs work in Spanish
    ...
    When I click the "Por definir" tab
    Then the "Por definir" tab should be selected, its panel visible and the other panel hidden
